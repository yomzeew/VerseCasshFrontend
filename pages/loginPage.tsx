...
const LoginPage=({setshowauth}:{setshowauth:(value:string)=>void})=>{
    ...
    return(
        ...
        <View>
            ...
            <View className="flex-row items-center">
                <Themetext fontsize={12}>I do not have an account </Themetext>
                <TouchableOpacity onPress={()=>setshowauth('signup')}><Themetext fontsize={16}>Sign up</Themetext></TouchableOpacity>
            </View>
            ...
            <View className="flex-row gap-x-2 items-center">
                ...
                <Themetext fontsize={20}>OR Sign in With</Themetext>
                <View className="border-b w-32 border-slate-400"/>
